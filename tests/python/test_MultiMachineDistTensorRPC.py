...
command = f"python3 test_DistTensorRPC.py -device_per_node {args.device_per_node} -cpu_collect {args.cpu_collect} -cpu_collect_gpu_send {args.cpu_collect_gpu_send} -test_ib {args.test_ib} -world_size {args.world_size} -device_per_node {args.device_per_node}"
